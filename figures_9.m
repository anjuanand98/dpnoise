...
load('parameters.mat');
load(strcat('uniform_str_k_',num2str(kencoder),'.mat'));
berval(4:5)=[];
fdfig=figure;
...
saveas(fdfig,'decdist_uniform_xminus1.5.png')
...
saveas(fefig,'encdist_uniform_xminus1.5.png')
...
for N=Nval
    ...
    saveas(fq,strcat('quantizers_N_',num2str(N),'.png'))
end
